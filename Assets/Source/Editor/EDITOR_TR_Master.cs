...
namespace Source.Editor
{
    ...
    public class EDITOR_RT_Master : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            objIrrelevantChange(ref obj.bAdvancedLighting ,
                EditorGUILayout.ToggleLeft("Advanced Lighting Options", obj.bAdvancedLighting));
            ...
            objIrrelevantChange(ref obj.bExposeSpheres, 
                EditorGUILayout.ToggleLeft("Show Sphere Fields", obj.bExposeSpheres));
